...
public class CoyoteAdapter implements Adapter {
    ...
    public CoyoteAdapter(Connector connector) {
        ...
        System.out.println("#### org.apache.catalina.connector.CoyoteAdapter ");
        System.out.println("#### (between Connector and Engine)");
    }
    ...
    public boolean asyncDispatch(org.apache.coyote.Request req,
        ...
        System.out.println("########## org.apache.catalina.connector.CoyoteAdapter#asyncDispatch");
        System.out.println("########## .CoyoteAdapter#asyncDispatch 连接请求");
    ...
    public void service(org.apache.coyote.Request req,
        ...
        System.out.println("########## .CoyoteAdapter#service 连接请求");
        ...
        try {
            ...
            if (postParseSuccess) {
                ...
                System.out.println("########## 358  org.apache.catalina.connector.CoyoteAdapter  Calling the container");
                connector.getService().getContainer().getPipeline().getFirst().invoke(request, response);
            }
            if (request.isAsync()) {
                async = true;
