...
public class NioEndpoint extends AbstractJsseEndpoint<NioChannel> {
    ...
    public NioEndpoint(){
        super();
        System.out.println("########## org.apache.tomcat.util.net.NioEndpoint ###########");
    }
    ...
    public void bind() throws Exception {
        ...
        System.out.println("## InetSocketAddress addr " + addr.toString() + " ##");
    ...
    protected class SocketProcessor extends SocketProcessorBase<NioChannel> {
        ...
        public SocketProcessor(SocketWrapperBase<NioChannel> socketWrapper, SocketEvent event) {
            ...
            System.out.println("##############  NioEndpoint-> class SocketProcessor");
        }
        ...
        protected void doRun() {
            ...
            try {
                ...
                if (handshake == 0) {
                    ...
                    System.out.println("#####NioEndpoint-> class SocketProcessor#socketWrapper " + socketWrapper.getClass());
                     System.out.println("#####NioEndpoint-> class SocketProcessor#getHandler() " + getHandler().getClass());
                    if (event == null) {
